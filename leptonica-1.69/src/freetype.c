...
{
	FT_Error err;
	ft_library_st *lib_ptr;
	
	lib_ptr =(ft_library_st*) CALLOC(1, sizeof(ft_library_st));
...
void
ftShutdownLibrary(ft_library_st  *lib_ptr)
{
    if (lib_ptr) {
...
PIX *
pixWriteTTFText(ft_library_st  *lib_ptr,
                PIX         *pixs,
                l_float32    size,
                l_float32    angle,
                l_int32      x,
...
int LEPTONICA_FT_RESOLUTION = 16;
